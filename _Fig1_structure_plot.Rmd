...
.ggsave(paste0("figures/structure_deltaTopic.pdf"), plot=plt.deltaTopic,
        width=7, height=3)
```
...
.ggsave(paste0("figures/structure_BETM_spliced.pdf"), plot=plt.BETM_spliced,
        width=7, height=3)
```
...
.ggsave(paste0("figures/structure_BETM_unspliced.pdf"), plot=plt.BETM_unspliced,
        width=7, height=3)
```
